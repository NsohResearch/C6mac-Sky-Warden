...
export const GLOBAL_REGULATORY_AUTHORITIES: CountryAuthority[] = [
  ...
  {
    countryCode: 'TD', countryName: 'Chad', flagEmoji: '🇹🇩', region: 'africa',
    authority: { name: "Autorité de l'Aviation Civile du Tchad", acronym: 'ADAC', website: 'https://www.adac-tchad.org', registrationPortal: null },
    regulations: { primaryRegulation: 'CEMAC RPAS Framework', pilotCertName: 'RPAS Operator Permit', registrationRequired: true, remoteIdRequired: 'not_required', remoteIdRegulation: null, maxAltitudeFt: 400, maxWeightKg: 25, laancEquivalent: null, authorizationSystem: 'ADAC Portal' },
    locale: { currency: 'XAF', dateFormat: 'DD/MM/YYYY', timeFormat: '24h', distanceUnit: 'meters', altitudeUnit: 'meters', speedUnit: 'km/h', weightUnit: 'kilograms', temperatureUnit: 'celsius' },
    emergencyNumber: '17', aviationEmergency: null,
  },
  {
    countryCode: 'CF', countryName: 'Central African Republic', flagEmoji: '🇨🇫', region: 'africa',
    authority: { name: "Autorité Nationale de l'Aviation Civile", acronym: 'ANAC-CF', website: null, registrationPortal: null },
    regulations: { primaryRegulation: 'CEMAC RPAS Framework', pilotCertName: 'RPAS Operator Permit', registrationRequired: true, remoteIdRequired: 'not_required', remoteIdRegulation: null, maxAltitudeFt: 400, maxWeightKg: 25, laancEquivalent: null, authorizationSystem: 'ANAC-CF Portal' },
    locale: { currency: 'XAF', dateFormat: 'DD/MM/YYYY', timeFormat: '24h', distanceUnit: 'meters', altitudeUnit: 'meters', speedUnit: 'km/h', weightUnit: 'kilograms', temperatureUnit: 'celsius' },
    emergencyNumber: '117', aviationEmergency: null,
  },
  {
    countryCode: 'CG', countryName: 'Republic of the Congo', flagEmoji: '🇨🇬', region: 'africa',
    authority: { name: "Agence Nationale de l'Aviation Civile", acronym: 'ANAC-CG', website: 'https://www.anac.cg', registrationPortal: null },
    regulations: { primaryRegulation: 'CEMAC RPAS Framework', pilotCertName: 'RPAS Operator Permit', registrationRequired: true, remoteIdRequired: 'not_required', remoteIdRegulation: null, maxAltitudeFt: 400, maxWeightKg: 25, laancEquivalent: null, authorizationSystem: 'ANAC-CG Portal' },
    locale: { currency: 'XAF', dateFormat: 'DD/MM/YYYY', timeFormat: '24h', distanceUnit: 'meters', altitudeUnit: 'meters', speedUnit: 'km/h', weightUnit: 'kilograms', temperatureUnit: 'celsius' },
    emergencyNumber: '117', aviationEmergency: null,
  },
  {
    countryCode: 'GQ', countryName: 'Equatorial Guinea', flagEmoji: '🇬🇶', region: 'africa',
    authority: { name: 'Dirección General de Aviación Civil', acronym: 'DGAC-GQ', website: null, registrationPortal: null },
    regulations: { primaryRegulation: 'CEMAC RPAS Framework', pilotCertName: 'RPAS Operator Permit', registrationRequired: true, remoteIdRequired: 'not_required', remoteIdRegulation: null, maxAltitudeFt: 400, maxWeightKg: 25, laancEquivalent: null, authorizationSystem: 'DGAC-GQ Portal' },
    locale: { currency: 'XAF', dateFormat: 'DD/MM/YYYY', timeFormat: '24h', distanceUnit: 'meters', altitudeUnit: 'meters', speedUnit: 'km/h', weightUnit: 'kilograms', temperatureUnit: 'celsius' },
    emergencyNumber: '114', aviationEmergency: null,
  },
  {
    countryCode: 'GA', countryName: 'Gabon', flagEmoji: '🇬🇦', region: 'africa',
    authority: { name: "Agence Nationale de l'Aviation Civile", acronym: 'ANAC-GA', website: 'https://www.anac.ga', registrationPortal: null },
    regulations: { primaryRegulation: 'CEMAC RPAS Framework', pilotCertName: 'RPAS Operator Permit', registrationRequired: true, remoteIdRequired: 'not_required', remoteIdRegulation: null, maxAltitudeFt: 400, maxWeightKg: 25, laancEquivalent: null, authorizationSystem: 'ANAC-GA Portal' },
    locale: { currency: 'XAF', dateFormat: 'DD/MM/YYYY', timeFormat: '24h', distanceUnit: 'meters', altitudeUnit: 'meters', speedUnit: 'km/h', weightUnit: 'kilograms', temperatureUnit: 'celsius' },
    emergencyNumber: '1730', aviationEmergency: null,
  },
  {
    countryCode: 'BW', countryName: 'Botswana', flagEmoji: '🇧🇼', region: 'africa',
    authority: { name: 'Civil Aviation Authority of Botswana', acronym: 'CAAB', website: 'https://www.caab.co.bw', registrationPortal: 'https://www.caab.co.bw' },
    regulations: { primaryRegulation: 'CAAB RPAS Regulations', pilotCertName: 'RPAS Operator Certificate', registrationRequired: true, remoteIdRequired: 'not_required', remoteIdRegulation: null, maxAltitudeFt: 400, maxWeightKg: 25, laancEquivalent: null, authorizationSystem: 'CAAB Portal' },
    locale: { currency: 'BWP', dateFormat: 'DD/MM/YYYY', timeFormat: '24h', distanceUnit: 'feet', altitudeUnit: 'feet', speedUnit: 'km/h', weightUnit: 'kilograms', temperatureUnit: 'celsius' },
    emergencyNumber: '999', aviationEmergency: null,
  },
  {
    countryCode: 'ZM', countryName: 'Zambia', flagEmoji: '🇿🇲', region: 'africa',
    authority: { name: 'Zambia Civil Aviation Authority', acronym: 'ZCAA', website: 'https://www.zcaa.co.zm', registrationPortal: 'https://www.zcaa.co.zm' },
    regulations: { primaryRegulation: 'ZCAA RPAS Regulations 2022', pilotCertName: 'RPAS Operator License', registrationRequired: true, remoteIdRequired: 'not_required', remoteIdRegulation: null, maxAltitudeFt: 400, maxWeightKg: 25, laancEquivalent: null, authorizationSystem: 'ZCAA Portal' },
    locale: { currency: 'ZMW', dateFormat: 'DD/MM/YYYY', timeFormat: '12h', distanceUnit: 'feet', altitudeUnit: 'feet', speedUnit: 'km/h', weightUnit: 'kilograms', temperatureUnit: 'celsius' },
    emergencyNumber: '999', aviationEmergency: null,
  },
  {
    countryCode: 'SS', countryName: 'South Sudan', flagEmoji: '🇸🇸', region: 'africa',
    authority: { name: 'South Sudan Civil Aviation Authority', acronym: 'SSCAA', website: null, registrationPortal: null },
    regulations: { primaryRegulation: 'SSCAA Aviation Regulations', pilotCertName: 'RPAS Operator Permit', registrationRequired: true, remoteIdRequired: 'not_required', remoteIdRegulation: null, maxAltitudeFt: 400, maxWeightKg: 25, laancEquivalent: null, authorizationSystem: 'SSCAA Portal' },
    locale: { currency: 'SSP', dateFormat: 'DD/MM/YYYY', timeFormat: '12h', distanceUnit: 'feet', altitudeUnit: 'feet', speedUnit: 'km/h', weightUnit: 'kilograms', temperatureUnit: 'celsius' },
    emergencyNumber: '999', aviationEmergency: null,
  },
  {
    countryCode: 'AO', countryName: 'Angola', flagEmoji: '🇦🇴', region: 'africa',
    authority: { name: 'Instituto Nacional da Aviação Civil', acronym: 'INAVIC', website: 'https://www.inavic.gov.ao', registrationPortal: null },
    regulations: { primaryRegulation: 'INAVIC RPAS Regulations', pilotCertName: 'RPAS Operator Authorization', registrationRequired: true, remoteIdRequired: 'not_required', remoteIdRegulation: null, maxAltitudeFt: 400, maxWeightKg: 25, laancEquivalent: null, authorizationSystem: 'INAVIC Portal' },
    locale: { currency: 'AOA', dateFormat: 'DD/MM/YYYY', timeFormat: '24h', distanceUnit: 'meters', altitudeUnit: 'meters', speedUnit: 'km/h', weightUnit: 'kilograms', temperatureUnit: 'celsius' },
    emergencyNumber: '113', aviationEmergency: null,
  },
  {
    countryCode: 'CD', countryName: 'Democratic Republic of the Congo', flagEmoji: '🇨🇩', region: 'africa',
    authority: { name: "Autorité de l'Aviation Civile", acronym: 'AAC-RDC', website: 'https://www.aac-rdc.cd', registrationPortal: null },
    regulations: { primaryRegulation: 'AAC-RDC Aviation Regulations', pilotCertName: 'RPAS Operator Permit', registrationRequired: true, remoteIdRequired: 'not_required', remoteIdRegulation: null, maxAltitudeFt: 400, maxWeightKg: 25, laancEquivalent: null, authorizationSystem: 'AAC-RDC Portal' },
    locale: { currency: 'CDF', dateFormat: 'DD/MM/YYYY', timeFormat: '24h', distanceUnit: 'meters', altitudeUnit: 'meters', speedUnit: 'km/h', weightUnit: 'kilograms', temperatureUnit: 'celsius' },
    emergencyNumber: '112', aviationEmergency: null,
  },
